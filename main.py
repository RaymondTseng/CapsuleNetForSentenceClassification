...
flags.DEFINE_float('regularization_scale', 0.15, 'regularization coefficient for reconstruction loss')

flags.DEFINE_string('train_data_path', './data/sst2.train.txt', 'the path of training dataset')
flags.DEFINE_string('test_data_path', './data/sst2.test.txt', 'the path of test dataset')
